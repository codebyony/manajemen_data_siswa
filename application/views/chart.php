...
<!-- grafik gender siswa, grafik tahun kelahiran siswa-->
    <!-- Main content -->
  ...
  var barChartData = {
    ...
    datasets : [
      
      {
        ...
        data : [<?php echo $aa?>,<?php echo $ab?>,<?php echo $ac?>,<?php echo $ad?>,<?php echo $ae?>,<?php echo $af?>,<?php echo $ag?>,<?php echo $ah?>]
      }
    ]
...
<script type="text/javascript">
  ...
  var pieChartCanvas = $('#pieChart').get(0).getContext('2d')
    ...
    var barChartData = {
      labels  : ['Malang', 'Surabaya', 'Blitar', 'Kediri', 'Banyuwangi', 'Probolinggo', 'Pasuruan','Sidoarjo','Jombang','Tuban'], datasets: [
        {
          label               : 'Electronics',
          fillColor           : 'rgba(34, 214, 222, 1)',
          strokeColor         : 'rgba(34, 214, 222, 1)',
          pointColor          : 'rgba(34, 214, 222, 1)',
          pointStrokeColor    : '#c1c7d1',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(220,220,220,1)',
          data                : [<?php echo $kota_asal1;?>, <?php echo $kota_asal2;?>, <?php echo $kota_asal3;?>, <?php echo $kota_asal4;?>, <?php echo $kota_asal5;?>, <?php echo $kota_asal6;?>, <?php echo $kota_asal7;?>,<?php echo $kota_asal8;?>,<?php echo $kota_asal9;?>,<?php echo $kota_asal10;?>]
        },
